...
public class Main {
	...
	public static <T> boolean contains2(List<T> list, T t, BiPredicate<T, T> pred2) {
		for (T i : list) {
			if (i == null && t == null)
				return true;
			if (i == null || t == null)
	...
	public static <T> boolean contains3(List<T> list, T t, BiPredicate<? super T, ? super T> pred3) {
	...
	public static <T> boolean contains4(List<? extends T> list,T t,BiPredicate<? super T, ? super T> pred4) {
		for(T i:list) {
			if (i == null && t == null)
				return true;
			if (i == null || t == null)
